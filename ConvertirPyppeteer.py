...
os.environ['PYPPETEER_DOWNLOAD_HOST'] = 'http://npm.taobao.org/mirrors'  # Otra fuente de descarga de Chromium

ruta_pdf='E:/ProyectoAire/FormatosAirePdf/PlantillaPdfCreadaPyppeteer.pdf'
...
asyncio.get_event_loop().run_until_complete(convertir_html_a_pdf('E:/ProyectoAire/FormatosAirePdf/CODIGO_HTML_b64.html', ruta_pdf))
#asyncio.get_event_loop().run_until_complete(convertir_html_a_pdf(contenido_html, ruta_pdf))