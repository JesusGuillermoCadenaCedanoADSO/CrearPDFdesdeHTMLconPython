...
ruta_pdf='E:/ProyectoAire/FormatosAirePdf/PlantillaPdfCreadaXHTML2.pdf'

def convertir_html_a_pdf(html_content, pdf_file):
    ...
    # Escribir el contenido del PDF en un archivo
    with open(pdf_file, 'wb') as f:
        pdf_buffer.seek(0)
        f.write(pdf_buffer.read())

convertir_html_a_pdf(contenido_html, ruta_pdf)